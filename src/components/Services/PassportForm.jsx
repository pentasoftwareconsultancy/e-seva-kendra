...
function PassportForm() {
  ...
  const [files, setFiles] = useState({ pan: null, aadhaar: null, photo: null, lightBill: null, rentAgreement: null });
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 md:p-10 space-y-6 sm:space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                ...
                <UploadBox label="Light Bill / लाइट बिल" fileData={files.lightBill} onChange={(e) => handleFileChange(e, "lightBill")} error={errors.lightBill} />
