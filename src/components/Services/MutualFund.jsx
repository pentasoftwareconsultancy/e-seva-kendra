...
const handleSubmit = (e) => {
  ...
  return (
    <div className="min-h-screen bg-[#f8faff] font-sans text-[#1e293b]">
      ...
      <section className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
          <div className="w-full md:w-1/2 space-y-4 sm:space-y-6 text-white">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold">Mutual Fund Investment Services</h1>
      ...
      {/* Form Section */}
      <section id="mutualfund-form" className="py-8 sm:py-10 px-4 sm:px-6 md:px-8 bg-[#f8faff]">
