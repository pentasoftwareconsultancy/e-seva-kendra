...
function GSTForm() {
    ...
    return (
        <div className="min-h-screen bg-[#f8faff] font-sans text-[#1e293b]">
            ...
            <section className="relative w-full h-[300px] sm:h-[400px] md:h-[550px] flex items-center">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
                    <div className="w-full md:w-1/2 space-y-4 sm:space-y-6 text-white">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold">GST Registration Services</h1>
            ...
            {/* Form Section */}
            <section id="gst-form" className="py-8 sm:py-10 px-4 md:px-8 bg-[#f8faff]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input type="tel" required pattern="[0-9]{10}" maxLength={10} value={formData.mobile} onChange={(e) => { const value = e.target.value.replace(/[^0-9]/g, ''); setFormData({...formData, mobile: value}); setErrors({...errors, mobile: ""}); }} placeholder="Enter Mobile Number" className={`w-full bg-[#f8faff] p-3 sm:p-4 rounded-xl ring-1 text-sm sm:text-base ${errors.mobile ? 'ring-red-500' : 'ring-gray-200'} focus:ring-2 focus:ring-[#1e40af]/20`} />
