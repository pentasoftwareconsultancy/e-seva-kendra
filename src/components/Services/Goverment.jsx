  ...
  return (
    <div className="min-h-screen bg-[#f8faff] font-sans text-[#1e293b]">
      ...
      <section className="relative w-full h-[250px] sm:h-[350px] md:h-[500px] flex items-center">
        <div className="absolute inset-0"><img src={Panhero} alt="Government Bonds" className="w-full h-full object-cover object-[20%_center]" /></div>
        <div className="absolute inset-0 bg-gradient-to-r from-[#0b2c6d]/95 via-[#143f8f]/80 to-transparent"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
          <div className="w-full md:w-1/2 space-y-3 sm:space-y-6 text-white">
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold">Government Bonds Services</h1>
            <p className="text-sm sm:text-lg md:text-xl text-gray-200">We provide fast and reliable assistance for Government Bonds application and investment.</p>
            <a href="#bonds-form">
      ...
      <section className="bg-white py-8 sm:py-12 px-3 sm:px-6 md:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white border-4 border-green-700 rounded-3xl p-4 sm:p-8 md:p-12 shadow-xl">
            <h2 className="text-xl sm:text-3xl font-bold text-green-600 text-center mb-2">सरकारी बाँडसाठी लागणारी कागदपत्रे</h2>
            <h3 className="text-base sm:text-2xl font-bold text-green-600 text-center mb-4 sm:mb-8 border-b-4 border-green-600 pb-3">Documents Required for Government Bonds</h3>
            <div className="space-y-3 text-sm sm:text-lg">
              {[
                ["पॅनकार्ड", "PAN Card"],
                ["आधारकार्ड", "Aadhaar Card"],
                ["बँक पासबुक", "Bank Passbook"],
                ["ई-मेल आय.डी. / मोबाईल नंबर", "Email ID / Mobile Number"],
      ...
      {/* FORM */}
      <section id="bonds-form" className="py-8 sm:py-12 px-3 sm:px-6 md:px-8 bg-[#f8faff]">
        <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden mb-10 sm:mb-20">
          <div className="bg-gradient-to-r from-blue-900 to-blue-700 px-4 sm:px-10 py-5 sm:py-8">
            <h2 className="text-lg sm:text-2xl md:text-3xl font-bold text-white text-center">Government Bonds Application Form</h2>
