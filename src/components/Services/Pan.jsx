...
>
  Apply Now
     ...
     <section className="bg-white py-12 sm:py-16 px-4 md:px-8"> <div className="max-w-4xl mx-auto"> <div className="bg-white border-4 border-green-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-xl"> <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-600 text-center mb-2"> पॅनकार्डसाठी लागणारी कागदपत्रे </h2> <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-green-600 text-center mb-6 sm:mb-8 border-b-4 border-green-600 pb-3 sm:pb-4"> Documents Required for PAN Card </h3> <div className="space-y-4 text-sm sm:text-base md:text-lg"> <div className="flex items-start gap-3"> <span className="text-green-600 font-bold text-xl">✱</span> <div> <p className="font-semibold">आधारकार्ड</p> <p className="text-gray-600">Aadhaar Card</p> </div> </div> <div className="flex items-start gap-3"> <span className="text-green-600 font-bold text-xl">✱</span> <div> <p className="font-semibold">३ पासपोर्ट साईज फोटो</p> <p className="text-gray-600">3 Passport Size Photographs</p> </div> </div> <div className="bg-pink-100 p-4 rounded-xl"> <h4 className="text-xl font-bold text-pink-600 mb-3"> नावात बदल पनकार्डसाठी लागणारी कागदपत्रे </h4> <h5 className="text-lg font-bold text-pink-600 mb-4"> Documents Required for Name Change PAN Card </h5> <div className="space-y-3"> <div className="flex items-start gap-3"> <span className="text-green-600 font-bold text-xl">✱</span> <div> <p className="font-semibold">आधारकार्ड</p> <p className="text-gray-600">Aadhaar Card</p> </div> </div> <div className="flex items-start gap-3"> <span className="text-green-600 font-bold text-xl">✱</span> <div> <p className="font-semibold">३ पासपोर्ट साईज फोटो</p> <p className="text-gray-600">3 Passport Size Photographs</p> </div> </div> <div className="flex items-start gap-3"> <span className="text-green-600 font-bold text-xl">✱</span> <div> <p className="font-semibold">लग्नपत्रिका</p> <p className="text-gray-600">Marriage Certificate</p> </div> </div> <div className="flex items-start gap-3"> <span className="text-green-600 font-bold text-xl">✱</span> <div> <p className="font-semibold">आधीच्या नावाचे जुने पॅनकार्ड</p> <p className="text-gray-600">Old PAN Card with Previous Name</p> </div> </div> </div> </div> </div> </div> </div> </section>
