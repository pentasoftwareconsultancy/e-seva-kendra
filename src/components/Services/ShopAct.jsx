...
function ShopAct() {
  ...
  const [files, setFiles] = useState({ pan: null, aadhaar: null, lightBill: null, photo: null, shopPhoto: null });
    ...
    navigate("/payment", {
      state: {
        ...
        documents: {
          ...
          shopPhoto: files.shopPhoto?.file,
        },
      },
    });
  };
  ...
  return (
    <div className="min-h-screen bg-[#f8faff] font-sans text-[#1e293b]">
      <section className="relative w-full h-[250px] sm:h-[350px] md:h-[500px] flex items-center">
        <div className="absolute inset-0"><img src={Panhero} alt="Shop Act" className="w-full h-full object-cover object-[20%_center]" /></div>
        <div className="absolute inset-0 bg-gradient-to-r from-[#0b2c6d]/95 via-[#143f8f]/80 to-transparent"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
          <div className="w-full md:w-1/2 space-y-3 sm:space-y-6 text-white">
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold">Shop Act License Services</h1>
            <p className="text-sm sm:text-lg md:text-xl text-gray-200">We provide fast and reliable assistance for Shop Act License application and registration.</p>
            <a href="#shopact-form"><button className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-black px-5 sm:px-8 py-2 sm:py-3 rounded-xl font-bold text-sm sm:text-base shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">Apply Now</button></a>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-8 sm:py-12 px-3 sm:px-6 md:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white border-4 border-green-700 rounded-3xl p-4 sm:p-8 md:p-12 shadow-xl">
            <h2 className="text-xl sm:text-3xl font-bold text-green-600 text-center mb-2">दुकान नोंदणी लायसन्स काढण्यासाठी लागणारी कागदपत्रे</h2>
            <h3 className="text-base sm:text-2xl font-bold text-green-600 text-center mb-4 sm:mb-8 border-b-4 border-green-600 pb-3">Documents Required for Shop Act License</h3>
            <div className="space-y-3 text-sm sm:text-lg">
              {[["पॅनकार्ड", "PAN Card"], ["आधारकार्ड", "Aadhaar Card"],  ["ई-मेल आय.डी. / मोबाईल नंबर", "Email ID / Mobile Number"], ["लाईटबिल", "Light Bill"], ["१ पासपोर्ट साईज फोटो", "1 Passport Size Photograph"],["दुकानाचा फोटो","Shop Photo"]].map((item, index) => (
      ...
      <section id="shopact-form" className="py-8 sm:py-12 px-3 sm:px-6 md:px-8 bg-[#f8faff]">
        <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden mb-10 sm:mb-20">
          <div className="bg-gradient-to-r from-blue-900 to-blue-700 px-4 sm:px-10 py-5 sm:py-8">
            <h2 className="text-lg sm:text-2xl md:text-3xl font-bold text-white text-center">Shop Act License Application Form</h2>
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 md:p-10 space-y-6 sm:space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                ...
                <UploadBox label="Passport Photo (पासपोर्ट फोटो)" fileData={files.photo} onChange={(e) => handleFileChange(e, "photo")} error={fileErrors.photo} />
                <UploadBox label="Shop Photo (दुकानाचा फोटो)" fileData={files.shopPhoto} onChange={(e) => handleFileChange(e, "shopPhoto")} error={fileErrors.shopPhoto} />
              </div>
            </div>
