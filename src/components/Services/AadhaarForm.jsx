...
function AadhaarForm() {
  return (
    ...
    />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
              <div className="w-full md:w-1/2 space-y-6 text-white">
                ...
                <p className="text-lg md:text-xl text-gray-200 leading-relaxed">
                  We provide fast and reliable assistance for   <br/> Aadhar Enrollment,
                   update, and Corrections.<br/>
          ...
          <section className="bg-[#f8faff] py-20 px-4 md:px-8">
            <div className="text-center mb-12">
              ...
              <h6  className="text-lg md:text-xl text-gray-500 leading-relaxed">Follow these simple steps to get your Aadhaar easily and quickly.</h6>
            </div>
      ...
      <div className="bg-white rounded-[32px] shadow overflow-hidden">
        ...
        <div className="p-4">
          <h3 className="font-bold text-xl mb-1"> 1. Fill Aadhaar Update/Enrollment && Form</h3>
      ...
      <div className="bg-white rounded-[32px] shadow overflow-hidden">
        ...
        <div className="p-4">
          <h3 className="font-bold text-xl mb-1">2. Upload Identity & Address Proof</h3>
      ...
      <div className="bg-white rounded-[32px] shadow overflow-hidden">
        ...
        <div className="p-4">
          <h3 className="font-bold text-xl mb-1">3. Receive Confirmation/Update Status</h3>
    ...
    <section className="py-5 px-4 md:px-8 bg-[#f8faff]">
      ...
      Fill the full form below to update your AAdhaar card details or to enroll for a new Aadhaar card.
    </p>
